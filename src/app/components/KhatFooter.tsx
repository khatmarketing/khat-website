  ...
  return (
    <footer className="site-footer">
      <div className="flex items-end justify-between gap-6">
        <div><Link href="/" className="inline-flex min-h-11 items-center text-3xl font-extrabold" aria-label="خط؛ صفحه اصلی">خط</Link><p className="mt-4 max-w-48 text-sm leading-7 text-white/65">بازاریابی، برندینگ<br />و رشد کسب‌وکارها</p></div>
